...
<!--  ==============================================================================================
    ...
    <div class="page-title bg-info">
        <ol class="breadcrumb text-right bg-info">
          ...
          <li class="active text-white"><b>Insurance </b></li>
        </ol>
    </div>
    </div>
    </div>
    ...
    <div class="col-sm-12">
        <center>
            <? if($collect_Weight == $drop_weight){?>
                ...
                <form action="controller/action-ctl.php" id="frmJobPost" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="command"    value="job_active">
                <input type="hidden" name="load_id"  value="<?php if($load_id){echo $load_id;}?>">  
                <a href="../load_list.php" class="text-dark col-sm-2 "></a>
                <button align="right" type="button"   data-toggle="modal" data-target="#myModal" data-backdrop="false" class="btn btn-info  block mt-3 mb-4">
