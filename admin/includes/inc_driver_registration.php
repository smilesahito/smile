                        ...
                        <form action="" method="post" class="">
                          <div class="form-group">
                            <div class="input-group">
                                  <select name="lorryowner"  class="form-control" required>
                                    <option value="" disabled selected> Choose a Lorry Owner</option>
								 <? foreach($lorryowner as $row){ ?>
                          ...
                          <div class="form-group">
                            <div class="input-group">
                             <div class="input-group-addon"><i class="fa fa-user"></i></div>
                              <input type="text" id="username" name="username" placeholder="Driver Name" class="form-control" required="true">
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="input-group">
                          ...
                          <div class="form-group">
                            <div class="input-group">
                                 <select name="city" data-placeholder="Choose a City..." class="form-control" required>
