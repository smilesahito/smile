 <?php
        $goods = GoodsOwner::GetAcceptedLoad();
        ...
        <tbody>
            ...
            <tr> 
                ...
                <td>
                    ...
                    <div class="col-md-4 bg-light p-2">Accepted By:</div>
                	<div class="col-md-8 p-2"><?=$val->accepted_by?></div>  
                	<div class="col-md-4 bg-light p-2">Contact No.:</div>
                	<div class="col-md-8 p-2"><?=$val->contact_no?></div>
