 <?    
      ...
      <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
           <span class="badge badge-pill badge-success">Success</span>
                 You are successfully add the Goods-Owner.
      ...
      <?php
	    if(isset($param) && $param == "4")
		  ...
		  <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
			   <span class="badge badge-pill badge-success">Success</span>
					 You are successfully update the Goods-Owner.
			   <button type="button" class="close" data-dismiss="alert" aria-label="Close">
				  <span aria-hidden="true">×</span>
			   </button>
		  </div>
      ...
      <? if(isset($param) && $param == "2")
         { ?>
         <div class="sufee-alert alert with-close alert-danger alert-dismissible fade show">
              <span class="badge badge-pill badge-danger">Success</span>
               You are successfully delete the Goods-Owner.
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                 <span aria-hidden="true">×</span>
              </button>
         </div>
    ...
    <div class="page-title">
         <ol class="breadcrumb text-right">
             ...
             <li class="active">Goods Owner List</li>
         </ol>
    </div>
    </div>
    </div>
    ...
    <div class="card-body table-responsive ">
          <table id="goodOnwer-data-table" class="table table-striped table-bordered">
                <thead>
                        ...
                        <tr>
                            ...
                            Details
                                ...
                                <div class="modal-header bg-primary">
                                      <h5 class="modal-title" id="mediumModalLabel">Goods Owner Detail</h5>
                            ...
                            <td><a href="/admin/edit_good_owner.php?userId=<?=$row1->user_id;?>" class="on-default edit-row text-primary" title="Edit"><i class="fa fa-pencil"></i></a> 
                           
                            <a href="controller/action-ctl.php?userId=<?=$row1->user_id;?>&command=deleteGoodOwner" onclick="return confirmDelete();" class="on-default remove-row text-danger ml-3" title="Delete"><i class="fa fa-trash-o"></i></a>
                            </td>
                            </tr>
							<?  } }?>
    ...
    <? 
        $owner = User::verifyUser(); 
        if(isset($param))
        {
   ?>
   <?   if($param=="3"){?> 
   <div class="col-md-12 sufee-alert alert with-close alert-success alert-dismissible fade show">
        <span class="badge badge-pill badge-success">Success</span>
