                ...
                <td>
                  ...
                  Details
                    ...
                    <div class="col-md-8 p-2">
                        <button type="button" class="btn btn-outline-success btn-sm" title="Download" onclick="location.href='controller/action-ctl.php?command=downloadfile&filename=<?=$row->truck_rc?>&foldername=<?=$config["rc_path"]?>';"><i class="fa fa-download"></i>
                        </button>
                    </div>                            
                    
                    <div class="col-md-4 bg-light p-2">Truck Documents:</div>
                    <div class="col-md-8 p-2">
                       <button type="button" class="btn btn-outline-success btn-sm" title="Download" onclick="location.href='controller/action-ctl.php?command=downloadfile&filename=<?=$row->truck_documents?>&foldername=<?=$config["documents_path"]?>';"><i class="fa fa-download"></i>
                        </button></div>                            
...
<!--=========================================================================================== -->
    ...
    <? 
    $truck = LorryOwner::GetTruckVerify(); 
    if(isset($param2))
    {?>
            ...
            <? if($truck)
               ...
               $a=1;
                ...
                <tr>
                    ...
                    <td><?=$row->status?></td>
                    <td>
                        <button type="button" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#<?=$row->truck_id?>">
                      Details
                        </button>
                       
                        <div class="modal fade" id="<?=$row->truck_id?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                        <div class="modal-header bg-primary">
                             <h5 class="modal-title" id="mediumModalLabel">Truck Detail</h5>
                    ...
                    <form class="form-horizontal" method="post" role="form" action="controller/action-ctl.php" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="command" value="active_truck">
                        <input type="hidden" name="user_id" value="<?=$row->truck_id?>">
                    <td>
